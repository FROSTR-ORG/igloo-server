...
export const hex = z.string()
  .regex(/^[0-9a-fA-F]*$/)
  .refine((value: string) => value.length % 2 === 0)

export const literal = z.union([ z.string(), z.number(), z.boolean(), z.null() ])
export const hex16   = hex.refine((value: string) => value.length === 32)
export const hex20   = hex.refine((value: string) => value.length === 40)
export const hex32   = hex.refine((value: string) => value.length === 64)
export const hex64   = hex.refine((value: string) => value.length === 128)
