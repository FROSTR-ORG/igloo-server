...
- `assets/`: Umbrel icon (512×512 PNG) and gallery screenshots (≥1024×768, 16:9).
...
3. Refresh the gallery captures whenever the UI meaningfully changes (keep them 16:9).
