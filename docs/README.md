...
- **Config** — `docs/CONFIG.md`: environment variables, CORS/WS Origin semantics, and operational tuning.
- **Auth Matrix** — `docs/AUTH_MATRIX.md`: endpoint availability by mode + what bypasses the global auth gate.
